...
public class RedisUtil {
    ...
    public static final String KEY_PREFIX_EM = "com.campusactivity";
    public static final Long TOKEN_TTL = 20 * 60L;
    ...
    public static class CaCheConfig {
        ...
        public CaCheConfig(String prefix, String name, Duration ttl) {
            this.key = String.format("%s_%s_", prefix, name);
            this.name = name;
            this.ttl = ttl;
        }
    }
